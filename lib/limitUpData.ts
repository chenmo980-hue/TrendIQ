 ...
 * Correct master data with 蓝盾光电 as 5连板 space dragon
 */
export const LIMIT_UP_STOCKS_DATA: LimitUpStock[] = [
  ...
  },
  {
    ...
    reason: '2连板智能电网与环保监测仪器双驱动，电力信息化设备加速。',
...
/**
 * Limit-Up grouped by hot sectors (strictly >= 2 limit-up/consecutive board companies per sector)
 */
export const SECTOR_LIMIT_UP_GROUPS: SectorLimitUpGroup[] = [
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[0], LIMIT_UP_STOCKS_DATA[13]], // 蓝盾光电 (5板), 航天彩虹 (首板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[1], LIMIT_UP_STOCKS_DATA[4]], // 天洋新材 (3板), 华西股份 (3板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[2], LIMIT_UP_STOCKS_DATA[7]], // 坤泰股份 (3板), 海洋王 (2板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[5], LIMIT_UP_STOCKS_DATA[6], LIMIT_UP_STOCKS_DATA[10]], // 澳洋健康 (3板), 博济医药 (2板), 神奇制药 (2板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[9], LIMIT_UP_STOCKS_DATA[17], LIMIT_UP_STOCKS_DATA[16]], // 共进股份 (2板), 瑞芯微 (首板), 鸿博股份 (首板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[8], LIMIT_UP_STOCKS_DATA[11], LIMIT_UP_STOCKS_DATA[12]], // 理工能科 (2板), 中核科技 (首板), 合纵科技 (首板)
  },
  {
    ...
    stocks: [LIMIT_UP_STOCKS_DATA[14], LIMIT_UP_STOCKS_DATA[15]], // 四川长虹 (首板), 华映科技 (首板)
  },
];

/**
 * Top Dragon & Tiger Seats Activity (authoritative static backbone)
 */
...
export function getLimitUpSummary(): LimitUpLadderSummary {
  ...
  return {
    ...
    totalLimitDown: 2,
    brokenCount: 5,
    sealSuccessRate: 79.2,
    ladderDistribution,
    yesterdayLimitUpReturn: 5.68,
