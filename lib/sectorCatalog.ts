...
export const SECTOR_DATABASE: SectorItem[] = [
  ...
  {
    code: 'BK_PETROCHEMICAL',
    bkCode: 'BK0464',
    name: '石油石化与油气资源',
    category: '周期资源',
    description: '原油开采、海上油气服务、炼化工程、天然气储运及大宗能源QDII。',
    leadStockCode: '601857',
    leadStockName: '中国石油',
    catalyst: '中东地缘政治与OPEC+挺价减产共振，原油期货及全球油气产业链供需维持紧平衡。',
    constituents: [
      { code: '601857', name: '中国石油', isLeader: true },
      { code: '600028', name: '中国石化' },
      { code: '601808', name: '中海油服' },
      { code: '600256', name: '广汇能源' },
      { code: '002353', name: '杰瑞股份' },
      { code: '161129', name: '易方达原油LOF' },
  ...
  },
  {
    ...
    name: '贵金属与黄金',
    category: '周期资源',
    description: '黄金矿山采选、白银精炼、避险保值与央行购金产业链。',
    leadStockCode: '601899',
    leadStockName: '紫金矿业',
    catalyst: '全球央行持续增加黄金外汇储备，降息预期与地缘避险驱动黄金价格屡创历史新高。',
    constituents: [
      { code: '601899', name: '紫金矿业', isLeader: true },
  ...
  },
  {
    ...
    name: '华为产业链与鸿蒙',
    category: '主线题材',
    description: '纯血鸿蒙HarmonyOS NEXT、昇腾AI算力集群、海思芯片与智驾车联。',
    leadStockCode: '601127',
    leadStockName: '赛力斯',
    catalyst: '纯血鸿蒙生态接入千万级应用，昇腾AI智算基础设施全面加速国产化替代。',
    constituents: [
      { code: '601127', name: '赛力斯', isLeader: true },
  ...
  {
    code: 'BK_BANK_DIVIDEND',
    bkCode: 'BK0475',
    name: '银行与高股息红利',
    category: '核心资产',
    description: '国有大型商业银行、长效高股息红利标的、长线险资重仓配置。',
    leadStockCode: '601398',
    leadStockName: '工商银行',
    catalyst: '低利率环境下高股息资产具备极佳防御性与稳定分红收益，长线长钱配置意愿坚挺。',
    constituents: [
      { code: '601398', name: '工商银行', isLeader: true },
